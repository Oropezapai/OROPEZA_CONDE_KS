...
public class ControladorCliente {
    ...
    public void MostrarClienes(JTable tablaTotalClientes){
        ...
        try{
            ...
            objetoCliente.setNombres(nombres.getText());
             objetoCliente.setApPaterno(appaterno.getText());
              ...
              JOptionPane.showConfirmDialog(null, " se guardó correctamente"); 
    ...
    public void Seleccionar (JTable totalcliente, JTextField id, JTextField nombres, JTextField appaterno, JTextField apmaterno){
        ...
        try {
            if(fila>=0){
                ...
                id.setText((String) totalcliente.getValueAt(fila, 0).toString());
                nombres.setText((String) totalcliente.getValueAt(fila, 1).toString());
                appaterno.setText((String) totalcliente.getValueAt(fila, 2).toString());
                apmaterno.setText((String) totalcliente.getValueAt(fila, 3).toString());
            }
